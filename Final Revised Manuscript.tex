...
\begin{document}
    ...
    \section*{Discussion and Results}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[width=0.375\linewidth]{CNN_1_kspace.png}
            \includegraphics[width=0.375\linewidth]{Kspace-2.png}
            \caption{k-space reconstruction using a CNN for medium intensity undersampled k-space, followed by three more images for heavily undersampled k-space.}
            \label{img:kspace-2}
        \end{figure}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[width=0.39\linewidth]{Image_2.png}
            \includegraphics[width=0.19\linewidth]{Undersampled-2.png}
            \caption{k-space reconstruction using a CNN for highly undersampled k-space. The image on the right is the undersampled image.}
            \label{img:image-1}
        \end{figure}

        \begin{figure}[h]
            \centering
            \includegraphics[width=0.31\linewidth]{CNN_1.png}
            \includegraphics[width=0.15\linewidth]{Undersampled-2.png}
            \includegraphics[width = 0.43\linewidth]{CNN_1_kspace.png}
        ...
        \begin{figure}[h]
            ...
            \includegraphics[width=0.24\linewidth]{Undersampled-1.png}
